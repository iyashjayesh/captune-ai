        ...
        <Dialog>
            <DialogTrigger asChild>
                {showUploadUI ? (
                    ...
                    <button className={cn("w-fit flex flex-row gap-1 items-center bg-red-500 hover:bg-red-600 text-white text-base font-semibold py-1 px-2 rounded-sm shadow-md", font.className)}>
